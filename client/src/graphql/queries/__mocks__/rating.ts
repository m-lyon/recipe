...
import { mockRecipeIdFive, mockRecipeIdThree } from '@recipe/graphql/__mocks__/ids';
...
export const mockGetRatingsRecipeFive = {
    request: {
        query: GET_RATINGS,
        variables: { recipeId: mockRecipeIdFive } satisfies GetRatingsQueryVariables,
    },
    result: {
        data: {
            __typename: 'Query',
